...
function Navbar() {
  ...
  return (
    <div className='sticky top-0'>
      <header className='relative w-full h-auto p-[1.5rem_1rem_1.5rem_1rem] bg-[#dfd0bb] shadow-sm shadow-[#251e16]'>
        <nav className='h-[2.25rem] mx-[1.6875rem] flex justify-between'>
          <div>
            <Link href='/'><p className={`${caveat.className} text-[1.875rem] font-semibold text-white`} ><span className='text-[#202124]'>k</span><span className='text-[#7d674c]'>hizra</span> <span className='text-[#202124]'>I</span><span className='text-[#7d674c]'>QBAL</span></p></Link>
          </div>
